...
#     eval_step = 1000
#     simTime = SimTime(1691983094209, 1692064648400)
#     exch = Exchange(
#         datadir, simTime,
#         initial_balance= {
#             'USDT': 200
...
#     # open short(sell)
#     # best bid should be (price=30571.1, amount=17)
